...
const VideoItemInfo sampleVideos[] = {
    ...
    {
        L"Bunny Video",
        L"ms-appx:///Content/SampleVideo_1280x720_2mb.mp4",
    },

	{
		L"Jetson Video MP4",
		L"ms-appx:///Content/testvideo.mp4",
	},

	{
		L"H264 video",
		L"ms-appx:///Content/a.h264", //NEEDS TO BE DECODED https://docs.microsoft.com/en-us/windows/win32/medfound/h-264-video-decoder
	},
