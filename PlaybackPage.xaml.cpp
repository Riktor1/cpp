...
void PlaybackPage::OnMediaOpened(MediaPlayer^ sender, Object^ args)
{
		...
		Windows::Media::Playback::SphericalVideoProjectionMode projMode = videoProjection->ProjectionMode;
        ...
        //}
		videoProjection->ProjectionMode.Equals(1);
        videoProjection->IsEnabled = false;
        videoProjection->HorizontalFieldOfViewInDegrees = 180;
